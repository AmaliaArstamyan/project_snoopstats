"""
Django settings for snoopstats project.
...
SECRET_KEY = 'django-insecure-o)1-(j)qhgurge-p8!2(nwl66)=62)+10m*sey_c35(72e=s)j'
...
EMAIL_HOST_PASSWORD = "password123"  # Use an App Password if using Gmail
...
WSGI_APPLICATION = 'snoopstats.wsgi.application'
